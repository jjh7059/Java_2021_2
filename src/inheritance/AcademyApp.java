...
public class AcademyApp {
	public static void main(String[] args) {
		...
		*/
		...
		// => 자식 클래스의 생성자를 이용하면 상속관계의 부모 인스턴스와 자식 인스턴스가 동시에 생성
		...
		persons[4] = new AcademyStaff(5000, "장길산", "관리팀");
		...
		for(AcademyPerson person:persons) {
			...
			//오버라이드 선언된 메소드를 호출하면 묵시적 객체 형변환에 의해 부모 인스턴스의
			//메소드 대신 자식 인스턴스 메소드 호출.
