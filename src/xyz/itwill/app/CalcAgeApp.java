...
//키보드로 이름과 태어난 연도를 입력받아 이름과 나이를 출력하는 프로그램을 작성하세요
//ex) 이름 입력 >> 홍길동
//    태어난 년도 입력 >> 2000
//    [결과]홍길동님의 나이는 22살입니다.
public class CalcAgeApp {
	public static void main(String[] args) {
		...
		//Date 클래스의 매개변수가 없는 생성자로 인스턴스를 생성하면 현재 시스템(운영체제 - OS)의
		//현재 날짜(시간)정보를 저장한 Date 인스턴스 생성
		Date now = new Date();
		//Date.toString() : Date 인스턴스에 저장된 날짜(시간)정보를 문자열로 변환하는 메소드
		...
		int currentYear = now.getYear() + 1900;  //now.getYear()를 호출하면 121이 반환
