...
public class Car {
	...
	//엔진정보(Engine 인스턴스)를 저장하기 위한 참조 필드 - 포함 관계(Association)
	//car class 에 engine class가 포함되어 있음 (direct association)
	...
	public void carDisplay() {
		...
		// => 참조필드에 인스턴스가 저장되어 있지 않은 상태에서 메소드 호출시 
		//	  NullPointerException 발생
		//NullPointerException : 참조변수에 NULL이 저장된 상태에서 메소드를 호출할 경우 발생되는 예외
		/*
